(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('@angular/common'), require('@angular/core'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('ng-select2-component', ['exports', 'rxjs', '@angular/common', '@angular/core', '@angular/forms'], factory) :
    (factory((global['ng-select2-component'] = {}),global.rxjs,global.ng.common,global.ng.core,global.ng.forms));
}(this, (function (exports,rxjs,common,core,forms) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var Select2 = /** @class */ (function () {
         ...
         */
            function (option, defaut) {
                return this.templates instanceof core.TemplateRef
                    || this.templates && this.templates[option.templateId] instanceof core.TemplateRef
                    || this.templates && this.templates[defaut] instanceof core.TemplateRef;
            };
        /**
         * @param {?} option
         * @param {?} defaut
         ...
         */
            function (value1, value2) {
                ...
                if (this.multiple
                    ...
                    try {
                        for (var _b = __values((( /** @type {?} */(value1)))), _c = _b.next(); !_c.done; _c = _b.next()) {
                            var e1 = _c.value;
                            /** @type {?} */
         ...
         */
            function (element, cssClasses) {
                ...
                try {
                    ...
                    try {
                        if (cssClasses_1_1 && !cssClasses_1_1.done && (_a = cssClasses_1.return))
                            _a.call(cssClasses_1);
                    }
                    finally {
                        if (e_2)
                            throw e_2.error;
        ...
        /** @nocollapse */
        Select2.ctorParameters = function () {
            return [
